# 🧠 Student Depression Detector – MindCheck
...
- Critical safety handling for suicidal ideation with immediate support resources  
- Batch analysis for evaluating multiple student records (CSV upload)  
- Visual insights using charts and gauges for better understanding  
- Modern UI built with Streamlit and custom CSS  
- Ethical and responsible AI approach (screening tool, not a diagnosis)  
...
- **Persistence**: Joblib (model and scaler)  
